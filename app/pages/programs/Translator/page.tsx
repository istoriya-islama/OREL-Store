...
const calculatorApp: AppData = {
    ...
    heroIsVideo: false,
    downloadUrl:
        'https://istoriya-islama.github.io/OREL/OREL Translator 2.0 installer.exe',
    description:
        'Мгновенный перевод текста на множество языков мира.',
    features: [
        {
            ...
            desc: 'Быстрый перевод на множество языков',
        }
    ],
    screenshots: [
        '/Screns/translator.png',
    ],
    changelog: [
        {
            version: '2.0',
